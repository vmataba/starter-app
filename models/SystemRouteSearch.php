...
/**
 * SystemRouteSearch represents the model behind the search form of `app\models\SystemRoute`.
 */
class SystemRouteSearch extends SystemRoute {
    ...
    public function rules() {
        return [
            ...
            [['module', 'controller', 'action', 'pretty_name', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    public function search($params) {
        ...
        $query->orderBy(['controller' => SORT_ASC]);
