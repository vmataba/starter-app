...
class FileTypeController extends BaseController {
    ...
    public function actionCreate() {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            \Yii::$app->getSession()->setFlash('success', 'New File Type has been successfully created');
    ...
    public function actionUpdate($id) {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            \Yii::$app->getSession()->setFlash('success', 'File Type has been successfully updated');
